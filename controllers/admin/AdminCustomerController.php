...
//		$customers = Customer::join('region', 'customer.region', '=', 'region.id')
//      ->join('subregion', 'customer.subregion', '=', 'subregion.id')
//      ->select('customer.id', 'customer.name', 'customer.phone', 'customer.email','region.name as region')
//      ->get();
