...
class Twig_Helper extends Twig_Extension
{
    public function getFunctions()
    {
        return array(
          ...
          new Twig_Function('fetchCart', 'fetchCart'),
          new Twig_Function('listBlog', 'listBlog'),
          new Twig_Function('listCollection', 'listCollection'),
          new Twig_Function('checkSignin', 'checkSignin')
        );
    }
    ...
    public function getFilters()
    {
        return array(
            ...
            new Twig_Filter('getItemFromArrId', 'getItemFromArrId'),
            new Twig_Filter('getSlider', 'getSlider'),
            new Twig_Filter('getMenu', 'getMenu'),
            new Twig_Filter('getSEO', 'getSEO'),
            new Twig_Filter('canonical', 'canonical')
        );
    }
